...
const {ParserStream}  =require(  "./lib/parserstream.js");
const {kColors, kFontFaces, kFontStyles}  =require(  "./lib/pdfconst.js");

module.exports=  class PDFParser extends EventEmitter { // inherit from event emitter
    //public static
