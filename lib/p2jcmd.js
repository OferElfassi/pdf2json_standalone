...
const {ParserStream, StringifyStream} =require( "./parserstream.js");
const PDFParser =require( "../pdfparser.js");

const { pkInfo, _PARSER_SIG : _PRO_TIMER } =require( "../pkinfo.js");

const { yargs } =require( "./p2jcmdarg.js");
